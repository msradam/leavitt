...
| payment_failure | single_down | baseline | Y | Y | inconclusive | no | 0 |
...
| cart_failure | multi_fail | baseline | Y | Y | inconclusive | no | 0 |
...
| ad_failure | single_down | baseline | Y | Y | inconclusive | no | 0 |
| ad_failure | multi_fail | leavitt | Y | N | inconclusive | no | 1 |
| ad_failure | multi_fail | baseline | Y | Y | inconclusive | no | 0 |
...
| recommendation_cache_failure | single_down | baseline | Y | Y | inconclusive | no | 0 |
| recommendation_cache_failure | multi_fail | leavitt | Y | N | inconclusive | no | 1 |
| recommendation_cache_failure | multi_fail | baseline | Y | Y | inconclusive | no | 0 |
...
| multi_fail | 0/5 found, 0 FP | 3/5 found, 0 FP |
| single_down | 3/5 found, 0 FP | 5/5 found, 0 FP |
